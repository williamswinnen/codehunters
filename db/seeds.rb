...
user1 = User.create!(email: "default1@default.com", password: "123456", username: "Ahmadou", walletaddress: "0x1D283923FAA4D44ad2bDE35c75EA4B1360cbDABd")
...
bounty3 = Bounty.create!(title: "db corrupted, not sure about a rollback", content: "my junior dev Ahmadou broke my code !", price_cents: 0.001, difficulty_level: 3, github_repo: "https://github.com/ruby-grape/grape/blob/master/lib/grape/api.rb", user: user, smartcontractaddress: "0xE7B17dd54bF1aE4f26A2F2Bee9118A53ad718918", company:'')
...
bounty7 = Bounty.create!(title: "if..else and ternary operator", content: "need a complete function", price_cents: 0.005, difficulty_level: 2, github_repo: "https://github.com/roMPrd/RubyHunters/blob/master/app/controllers/bounties_controller.rb", user: user1, smartcontractaddress: "0xE7B17dd54bF1aE4f26A2F2Bee9118A53ad718918", company:'')
...
bounty9 = Bounty.create!(title: "surface covered algo", content: " write a function which calculates the area covered by a union of rectangles.", price_cents: 0.002, difficulty_level: 3, github_repo: "https://github.com/roMPrd/RubyHunters/blob/master/app/controllers/bounties_controller.rb", user: user2, smartcontractaddress: "0xE7B17dd54bF1aE4f26A2F2Bee9118A53ad718918", company:'')
bounty10 = Bounty.create!(title: "binomial expansion", content: "write a program that can do some algebra", price_cents: 0.04, difficulty_level: 4, github_repo: "https://github.com/roMPrd/RubyHunters/blob/master/app/controllers/dashboard_controller.rb", user: user3, smartcontractaddress: "0xE7B17dd54bF1aE4f26A2F2Bee9118A53ad718918", company:'')
...
bounty13 = Bounty.create!(title: "Currency conversion in JavaScript", content: "Convert between different currencies using JavaScript", price_cents: 0.0032, difficulty_level: 4, github_repo: "https://github.com/roMPrd/RubyHunters/blob/master/app/controllers/dashboard_controller.rb", user: user4, smartcontractaddress: "0xE7B17dd54bF1aE4f26A2F2Bee9118A53ad718918", company:'')
bounty14 = Bounty.create!(title: "Add React Components", content: "Add React components to the application", price_cents: 0.0023, difficulty_level: 4, github_repo: "https://github.com/roMPrd/RubyHunters/blob/master/app/controllers/dashboard_controller.rb", user: user5, smartcontractaddress: "0xE7B17dd54bF1aE4f26A2F2Bee9118A53ad718918", company:'')
bounty15 = Bounty.create!(title: "Fixing the Database that i can't query properly", content: 'Incorrectly querying the database', price_cents: 0.0068, difficulty_level: 2, github_repo: 'https://github.com/roMPrd/RubyHunters/blob/master/app/controllers/dashboard_controller.rb', user: user5, smartcontractaddress: "0xE7B17dd54bF1aE4f26A2F2Bee9118A53ad718918", company:'')
bounty16 = Bounty.create!(title: "Digital Root", content: 'given n, take the sum of the digits of n. If that value has more than one digit, continue reducing in this way until a single-digit number is produced', price_cents: 0.003, difficulty_level: 3, github_repo: 'https://github.com/roMPrd/RubyHunters/blob/master/app/controllers/dashboard_controller.rb', user: user5, smartcontractaddress: "0xE7B17dd54bF1aE4f26A2F2Bee9118A53ad718918", company:'')
bounty17 = Bounty.create!(title: "need a 'like-bar'", content: 'implement the function which takes an array containing the names of people that like an item', price_cents: 0.0058, difficulty_level: 4, github_repo: 'https://github.com/roMPrd/RubyHunters/blob/master/app/controllers/dashboard_controller.rb', user: user6, smartcontractaddress: "0xE7B17dd54bF1aE4f26A2F2Bee9118A53ad718918", company:'')
bounty18 = Bounty.create!(title: "combine override in material UI (React)", content: 'need to customise both the overall theme styling and the component styling at once in Material UI', price_cents: 0.0068, difficulty_level: 5, github_repo: 'https://github.com/roMPrd/RubyHunters/blob/master/app/controllers/dashboard_controller.rb', user: user6, smartcontractaddress: "0xE7B17dd54bF1aE4f26A2F2Bee9118A53ad718918", company:'')
bounty19 = Bounty.create!(title: "Show partial previous and next item on PageTabViewStyle", content: 'create a pager (PageTabViewStyle) that shows a little piece of the previous and next item', price_cents: 0.004, difficulty_level: 2, github_repo: 'https://github.com/roMPrd/RubyHunters/blob/master/app/controllers/dashboard_controller.rb', user: user8, smartcontractaddress: "0xE7B17dd54bF1aE4f26A2F2Bee9118A53ad718918", company:'')
bounty20 = Bounty.create!(title: "looping video material in SceneKit for iOS app", content: 'create a material in SceneKit that plays a looping video', price_cents: 0.0004, difficulty_level: 4, github_repo: 'https://github.com/roMPrd/RubyHunters/blob/master/app/controllers/dashboard_controller.rb', user: user8, smartcontractaddress: "0xE7B17dd54bF1aE4f26A2F2Bee9118A53ad718918", company:'')
bounty21 = Bounty.create!(title: "reset the value of operator in calculator", content: 'reset my custom made calculator', price_cents: 0.0054, difficulty_level: 3, github_repo: 'https://github.com/roMPrd/RubyHunters/blob/master/app/controllers/dashboard_controller.rb', user: user6, smartcontractaddress: "0xE7B17dd54bF1aE4f26A2F2Bee9118A53ad718918", company:'')
bounty22 = Bounty.create!(title: "finding the root directory of a dependency in NPM", content: 'get the root directory of my script', price_cents: 0.0034, difficulty_level: 2, github_repo: 'https://github.com/roMPrd/RubyHunters/blob/master/app/controllers/dashboard_controller.rb', user: user6, smartcontractaddress: "0xE7B17dd54bF1aE4f26A2F2Bee9118A53ad718918", company:'')
