...
Bounty.create!(title: "iteration on array", content: "I can't iterate properly", price_cents: 1000, difficulty_level: 300, github_repo: "https://github.com/roMPrd/RubyHunters", user: user1)
