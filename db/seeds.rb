...
bounty1 = Bounty.create!(deadline: Date.new(2023, 5, 12), title: "can't get my variable to display anything", content: "Somehow when i call the variable 'x' on line 73 it isn't showing see the repo", price_cents: Money.new(1_099), difficulty_level: 1, github_repo: "https://github.com/ruby-grape/grape/blob/master/lib/grape/api.rb", user: user)
bounty2 = Bounty.create!(deadline: Date.new(2022, 12, 29), title: "error 404 on a button, anchor/routing problem", content: "can't find the proper html anchor for my 'link_to' button", price_cents: Money.new(1_500), difficulty_level: 1, github_repo: "https://github.com/ruby-grape/grape/blob/master/lib/grape/api.rb", user: user)
bounty3 = Bounty.create!(title: "db corrupted, not sure about a rollback", content: "my junior dev Ahmadou broke my code !", price_cents: Money.new(10_500), difficulty_level: 3, github_repo: "https://github.com/ruby-grape/grape/blob/master/lib/grape/api.rb", user: user)
bounty4 = Bounty.create!(title: "iteration on an array does give me the proper elements", content: "I can't iterate properly", price_cents: Money.new(4_500), difficulty_level: 2, github_repo: "https://github.com/ruby-grape/grape/blob/master/lib/grape/api.rb", user: user1)
...
bounty6 = Bounty.create!(title: "find maximum and minimum values of a list", content: "I need two functions that recieves a list of integers", price_cents: Money.new(3500), difficulty_level: 1, github_repo: "https://github.com/ruby-grape/grape/blob/master/lib/grape/api.rb", user: user1)
bounty7 = Bounty.create!(title: "if..else and ternary operator", content: "need a complete function", price_cents: Money.new(11_000), difficulty_level: 2, github_repo: "https://github.com/roMPrd/RubyHunters/blob/master/app/controllers/bounties_controller.rb", user: user1)
bounty8 = Bounty.create!(title: "is it a palindrome?", content: "need a full case insensitive function", price_cents: Money.new(6_100), difficulty_level: 2, github_repo: "https://github.com/roMPrd/RubyHunters/blob/master/app/controllers/bounties_controller.rb", user: user2)
bounty9 = Bounty.create!(title: "surface covered algo", content: " write a function which calculates the area covered by a union of rectangles.", price_cents: Money.new(12500), difficulty_level: 3, github_repo: "https://github.com/roMPrd/RubyHunters/blob/master/app/controllers/bounties_controller.rb", user: user2)
bounty10 = Bounty.create!(title: "binomial expansion", content: "write a program that can do some algebra", price_cents: Money.new(20_500), difficulty_level: 4, github_repo: "https://github.com/roMPrd/RubyHunters/blob/master/app/controllers/dashboard_controller.rb", user: user3)
bounty11 = Bounty.create!(title: "How many arguments", content: "can't get my function that takes a random number of arguments to work", price_cents: Money.new(10_500), difficulty_level: 2, github_repo: "https://github.com/roMPrd/RubyHunters/blob/master/app/controllers/dashboard_controller.rb", user: user3)
bounty12 = Bounty.create!(title: "the main controller of my meatball application isn't working", content: "my poorly designed cheap webapp isn't working", price_cents: Money.new(1_500), difficulty_level: 2, github_repo: "https://github.com/roMPrd/RubyHunters/blob/master/app/controllers/dashboard_controller.rb", user: user3)
bounty13 = Bounty.create!(title: "Currency conversion in JavaScript", content: "Convert between different currencies using JavaScript", price_cents: Money.new(11_500), difficulty_level: 4, github_repo: "https://github.com/roMPrd/RubyHunters/blob/master/app/controllers/dashboard_controller.rb", user: user4)
bounty14 = Bounty.create!(title: "Add React Components", content: "Add React components to the application", price_cents: Money.new(12_800), difficulty_level: 4, github_repo: "https://github.com/roMPrd/RubyHunters/blob/master/app/controllers/dashboard_controller.rb", user: user5)
bounty15 = Bounty.create!(title: "Fixing the Database that i can't query properly", content: 'Incorrectly querying the database', price_cents: Money.new(1_900), difficulty_level: 2, github_repo: 'https://github.com/roMPrd/RubyHunters/blob/master/app/controllers/dashboard_controller.rb', user: user5)
bounty16 = Bounty.create!(title: "Digital Root", content: 'given n, take the sum of the digits of n. If that value has more than one digit, continue reducing in this way until a single-digit number is produced', price_cents: Money.new(9_500), difficulty_level: 3, github_repo: 'https://github.com/roMPrd/RubyHunters/blob/master/app/controllers/dashboard_controller.rb', user: user5)
bounty17 = Bounty.create!(title: "need a 'like-bar'", content: 'implement the function which takes an array containing the names of people that like an item', price_cents: Money.new(8_500), difficulty_level: 4, github_repo: 'https://github.com/roMPrd/RubyHunters/blob/master/app/controllers/dashboard_controller.rb', user: user6)
bounty18 = Bounty.create!(title: "combine override in material UI (React)", content: 'need to customise both the overall theme styling and the component styling at once in Material UI', price_cents: Money.new(15_500), difficulty_level: 5, github_repo: 'https://github.com/roMPrd/RubyHunters/blob/master/app/controllers/dashboard_controller.rb', user: user6)
bounty19 = Bounty.create!(title: "Show partial previous and next item on PageTabViewStyle", content: 'create a pager (PageTabViewStyle) that shows a little piece of the previous and next item', price_cents: Money.new(9_500), difficulty_level: 2, github_repo: 'https://github.com/roMPrd/RubyHunters/blob/master/app/controllers/dashboard_controller.rb', user: user8)
bounty20 = Bounty.create!(title: "looping video material in SceneKit for iOS app", content: 'create a material in SceneKit that plays a looping video', price_cents: Money.new(15_500), difficulty_level: 4, github_repo: 'https://github.com/roMPrd/RubyHunters/blob/master/app/controllers/dashboard_controller.rb', user: user8)
bounty21 = Bounty.create!(title: "reset the value of operator in calculator", content: 'reset my custom made calculator', price_cents: Money.new(9_500), difficulty_level: 3, github_repo: 'https://github.com/roMPrd/RubyHunters/blob/master/app/controllers/dashboard_controller.rb', user: user6)
bounty22 = Bounty.create!(title: "finding the root directory of a dependency in NPM", content: 'get the root directory of my script', price_cents: Money.new(6_500), difficulty_level: 2, github_repo: 'https://github.com/roMPrd/RubyHunters/blob/master/app/controllers/dashboard_controller.rb', user: user6)
...
solution17 = Solution.create!(content: "created React components for the application using the 'create-react-app' library", bounty: bounty14, user: user, github_repo:"https://github.com/heartcombo/devise", status:"accepted")
