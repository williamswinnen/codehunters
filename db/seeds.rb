...
bounty3 = Bounty.create!(title: "db corrupted, not sure about a rollback", content: "my junior dev Ahmadou broke my code !", price_cents: 0.01, difficulty_level: 3, github_repo: "https://github.com/ruby-grape/grape/blob/master/lib/grape/api.rb", user: user, smartcontractaddress: "0xE7B17dd54bF1aE4f26A2F2Bee9118A53ad718918")
bounty4 = Bounty.create!(title: "iteration on an array does give me the proper elements", content: "I can't iterate properly", price_cents: 0.012, difficulty_level: 2, github_repo: "https://github.com/ruby-grape/grape/blob/master/lib/grape/api.rb", user: user1, smartcontractaddress: "0xE7B17dd54bF1aE4f26A2F2Bee9118A53ad718918")
bounty5 = Bounty.create!(title: "localize the barycenter of a triangle", content: "need to localize the barycenter or centroid of a triangle", price_cents: 0.0455, difficulty_level: 4, github_repo: "https://github.com/ruby-grape/grape/blob/master/lib/grape/api.rb", user: user1, smartcontractaddress: "0xE7B17dd54bF1aE4f26A2F2Bee9118A53ad718918")
bounty6 = Bounty.create!(title: "find maximum and minimum values of a list", content: "I need two functions that recieves a list of integers", price_cents: 0.046, difficulty_level: 1, github_repo: "https://github.com/ruby-grape/grape/blob/master/lib/grape/api.rb", user: user1, smartcontractaddress: "0xE7B17dd54bF1aE4f26A2F2Bee9118A53ad718918")
bounty7 = Bounty.create!(title: "if..else and ternary operator", content: "need a complete function", price_cents: 0.5, difficulty_level: 2, github_repo: "https://github.com/roMPrd/RubyHunters/blob/master/app/controllers/bounties_controller.rb", user: user1, smartcontractaddress: "0xE7B17dd54bF1aE4f26A2F2Bee9118A53ad718918")
bounty8 = Bounty.create!(title: "is it a palindrome?", content: "need a full case insensitive function", price_cents: 0.845, difficulty_level: 2, github_repo: "https://github.com/roMPrd/RubyHunters/blob/master/app/controllers/bounties_controller.rb", user: user2, smartcontractaddress: "0xE7B17dd54bF1aE4f26A2F2Bee9118A53ad718918")
bounty9 = Bounty.create!(title: "surface covered algo", content: " write a function which calculates the area covered by a union of rectangles.", price_cents: 1.2, difficulty_level: 3, github_repo: "https://github.com/roMPrd/RubyHunters/blob/master/app/controllers/bounties_controller.rb", user: user2, smartcontractaddress: "0xE7B17dd54bF1aE4f26A2F2Bee9118A53ad718918")
bounty10 = Bounty.create!(title: "binomial expansion", content: "write a program that can do some algebra", price_cents: 3.4, difficulty_level: 4, github_repo: "https://github.com/roMPrd/RubyHunters/blob/master/app/controllers/dashboard_controller.rb", user: user3, smartcontractaddress: "0xE7B17dd54bF1aE4f26A2F2Bee9118A53ad718918")
bounty11 = Bounty.create!(title: "How many arguments", content: "can't get my function that takes a random number of arguments to work", price_cents: 0.65, difficulty_level: 2, github_repo: "https://github.com/roMPrd/RubyHunters/blob/master/app/controllers/dashboard_controller.rb", user: user3, smartcontractaddress: "0xE7B17dd54bF1aE4f26A2F2Bee9118A53ad718918")
bounty12 = Bounty.create!(title: "the main controller of my meatball application isn't working", content: "my poorly designed cheap webapp isn't working", price_cents: 0.25, difficulty_level: 2, github_repo: "https://github.com/roMPrd/RubyHunters/blob/master/app/controllers/dashboard_controller.rb", user: user3, smartcontractaddress: "0xE7B17dd54bF1aE4f26A2F2Bee9118A53ad718918")
bounty13 = Bounty.create!(title: "Currency conversion in JavaScript", content: "Convert between different currencies using JavaScript", price_cents: 2.3, difficulty_level: 4, github_repo: "https://github.com/roMPrd/RubyHunters/blob/master/app/controllers/dashboard_controller.rb", user: user4, smartcontractaddress: "0xE7B17dd54bF1aE4f26A2F2Bee9118A53ad718918")
bounty14 = Bounty.create!(title: "Add React Components", content: "Add React components to the application", price_cents: 3.5, difficulty_level: 4, github_repo: "https://github.com/roMPrd/RubyHunters/blob/master/app/controllers/dashboard_controller.rb", user: user5, smartcontractaddress: "0xE7B17dd54bF1aE4f26A2F2Bee9118A53ad718918")
bounty15 = Bounty.create!(title: "Fixing the Database that i can't query properly", content: 'Incorrectly querying the database', price_cents: 0.68, difficulty_level: 2, github_repo: 'https://github.com/roMPrd/RubyHunters/blob/master/app/controllers/dashboard_controller.rb', user: user5, smartcontractaddress: "0xE7B17dd54bF1aE4f26A2F2Bee9118A53ad718918")
bounty16 = Bounty.create!(title: "Digital Root", content: 'given n, take the sum of the digits of n. If that value has more than one digit, continue reducing in this way until a single-digit number is produced', price_cents: Money.new(9_500), difficulty_level: 3, github_repo: 'https://github.com/roMPrd/RubyHunters/blob/master/app/controllers/dashboard_controller.rb', user: user5, smartcontractaddress: "0xE7B17dd54bF1aE4f26A2F2Bee9118A53ad718918")
...
bounty21 = Bounty.create!(title: "reset the value of operator in calculator", content: 'reset my custom made calculator', price_cents: 0.054, difficulty_level: 3, github_repo: 'https://github.com/roMPrd/RubyHunters/blob/master/app/controllers/dashboard_controller.rb', user: user6, smartcontractaddress: "0xE7B17dd54bF1aE4f26A2F2Bee9118A53ad718918")
bounty22 = Bounty.create!(title: "finding the root directory of a dependency in NPM", content: 'get the root directory of my script', price_cents: 0.25, difficulty_level: 2, github_repo: 'https://github.com/roMPrd/RubyHunters/blob/master/app/controllers/dashboard_controller.rb', user: user6, smartcontractaddress: "0xE7B17dd54bF1aE4f26A2F2Bee9118A53ad718918")
