...
bounty1 = Bounty.create!(title: "can't get my variable to display anything", content: "Somehow when i call the variable 'x' on line 73 it isn't showing see the repo", price_cents: 1_099, difficulty_level: 1, github_repo: "https://github.com/roMPrd/RubyHunters", user: user)
bounty2 = Bounty.create!(title: "error 404 on a button, anchor/routing problem", content: "can't find the proper html anchor for my 'link_to' button", price_cents: 1_500, difficulty_level: 1, github_repo: "https://github.com/lewagon/rails-watch-list", user: user)
bounty3 = Bounty.create!(title: "db corrupted, not sure about a rollback", content: "my junior dev Ahmadou broke my code !", price_cents: 10_500, difficulty_level: 3, github_repo: "https://github.com/lewagon/python-scraping-workshop", user: user)
bounty4 = Bounty.create!(title: "iteration on an array does give me the proper elements", content: "I can't iterate properly", price_cents: 4_500, difficulty_level: 2, github_repo: "https://github.com/lucasgday/cryptozombies", user: user)
...
bounty9 = Bounty.create!(title: "surface covered algo", content: " write a function which calculates the area covered by a union of rectangles.", price_cents: 12500, difficulty_level: 3, github_repo: "https://github.com/sarahlafer/blog-prep-288", user: user1)
...
bounty12 = Bounty.create!(title: "the main controller of my meatball application isn't working", content: "my poorly designed cheap webapp isn't working", price_cents: 1_500, difficulty_level: 1, github_repo: "https://github.com/lewagon/rails-watch-list", user: user5)
...
bounty15 = Bounty.create!(title: "Fixing the Database that i can't query properly", content: 'Incorrectly querying the database', price_cents: 1_900, difficulty_level: 2, github_repo: 'https://github.com/lewagon/dribbble-card-solution', user: user)
