...
bounty1 = Bounty.create!(title: "can't get my variable to display anything", content: "Somehow when i call the variable 'x' on line 73 it isn't showing see the repo", price_cents: Money.new(1_099), difficulty_level: 1, github_repo: "https://github.com/ruby-grape/grape/blob/master/lib/grape/api.rb", user: user)
bounty2 = Bounty.create!(title: "error 404 on a button, anchor/routing problem", content: "can't find the proper html anchor for my 'link_to' button", price_cents: Money.new(1_500), difficulty_level: 1, github_repo: "https://github.com/ruby-grape/grape/blob/master/lib/grape/api.rb", user: user)
