...
solution1 = Solution.create!(content: "you forgot to wrap your string with '' !", bounty: bounty1, user: user2)
solution2 = Solution.create!(content: "this is an <a href> issue.", bounty: bounty2, user: user2)
solution3 = Solution.create!(content: "in this case <%=link_to%> could be appropriate", bounty: bounty2, user: user2)
solution4 = Solution.create!(content: "use db:rollback to reverse the said migration !", bounty: bounty3, user: user2)
solution5 = Solution.create!(content: "i created a migration that suppresses the table column", bounty: bounty3, user: user2)
solution6 = Solution.create!(content: "i used a map", bounty: bounty4, user: user2)
solution7 = Solution.create!(content: "you should simply use each do", bounty: bounty4, user: user2)
solution8 = Solution.create!(content: "used a very simple 3 parameters function", bounty: bounty5, user: user2)
solution9 = Solution.create!(content: "i managed to pull it in a single function", bounty: bounty6, user: user2)
solution10 = Solution.create!(content: "wrote two functions which take the said list as an argument", bounty: bounty6, user: user2)
solution11 = Solution.create!(content: "wrote a simple one line function", bounty: bounty7, user: user2)
solution12 = Solution.create!(content: "the function i wrote works on palindromes and is case insensitive", bounty: bounty8, user: user2)
solution13 = Solution.create!(content: "the surface covered by the area is correctly calculated, see the tests", bounty: bounty9, user: user2)
solution14 = Solution.create!(content: "the algebraical results validate the tests", bounty: bounty10, user: user2)
