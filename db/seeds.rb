...
bounty12 = Bounty.create!(title: "the main controller of my meatball application isn't working", content: "my poorly designed cheap webapp isn't working", price_cents: Money.new(1_500), difficulty_level: 1, github_repo: "https://github.com/opal/opal/blob/master/lib/opal/sprockets/environment.rb", user: user5)
