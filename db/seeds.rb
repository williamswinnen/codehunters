...
solution21 = Solution.create!(content: "implemented it using struct ContentView: View { ", bounty: bounty19, user: user6, github_repo:"https://github.com/heartcombo/devise", status: "accepted")
