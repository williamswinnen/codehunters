...
solution1 = Solution.create!(content: "you forgot to wrap your string with '' !", bounty: bounty1, user: user2, github_repo:"https://github.com/roMPrd/RubyHunters")
...
solution4 = Solution.create!(content: "use db:rollback to reverse the said migration !", bounty: bounty3, user: user2, github_repo:"https://github.com/roMPrd/RubyHunters")
...
solution13 = Solution.create!(content: "the surface covered by the area is correctly calculated, see the tests", bounty: bounty9, user: user2, github_repo:"https://github.com/roMPrd/RubyHunters")
solution14 = Solution.create!(content: "the algebraical results validate the tests", bounty: bounty10, user: user2, github_repo:"https://github.com/roMPrd/RubyHunters")
