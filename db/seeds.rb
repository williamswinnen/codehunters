...
bounty2 = Bounty.create!(title: "error 404 on a button, anchor/routing problem", content: "can't find the proper html anchor for my 'link_to' button", price_cents: Money.new(1_500), difficulty_level: 1, github_repo: "https://github.com/lewagon/rails-watch-list", user: user)
bounty3 = Bounty.create!(title: "db corrupted, not sure about a rollback", content: "my junior dev Ahmadou broke my code !", price_cents: Money.new(10_500), difficulty_level: 3, github_repo: "https://github.com/lewagon/python-scraping-workshop", user: user)
bounty4 = Bounty.create!(title: "iteration on an array does give me the proper elements", content: "I can't iterate properly", price_cents: Money.new(4_500), difficulty_level: 2, github_repo: "https://github.com/lucasgday/cryptozombies", user: user)
bounty5 = Bounty.create!(title: "localize the barycenter of a triangle", content: "need to localize the barycenter or centroid of a triangle", price_cents: Money.new(45000), difficulty_level: 4, github_repo: "https://github.com/dmilon/osteopathe-orlienas", user: user1)
bounty6 = Bounty.create!(title: "find maximum and minimum values of a list", content: "I need two functions that recieves a list of integers", price_cents: Money.new(3500), difficulty_level: 1, github_repo: "https://github.com/juliends/parks_and_plants", user: user1)
bounty7 = Bounty.create!(title: "if..else and ternary operator", content: "need a complete function", price_cents: Money.new(11_000), difficulty_level: 2, github_repo: "https://github.com/juliends/rails-7-testing", user: user1)
bounty8 = Bounty.create!(title: "is it a palindrome?", content: "need a full case insensitive function", price_cents: Money.new(6_100), difficulty_level: 2, github_repo: "https://github.com/sarahlafer/baby-robin", user: user1)
bounty9 = Bounty.create!(title: "surface covered algo", content: " write a function which calculates the area covered by a union of rectangles.", price_cents: Money.new(12500), difficulty_level: 3, github_repo: "https://github.com/sarahlafer/blog-prep-288", user: user1)
bounty10 = Bounty.create!(title: "binomial expansion", content: "write a program that can do some algebra", price_cents: Money.new(20_500), difficulty_level: 4, github_repo: "https://github.com/quynpham/adoptme", user: user1)
bounty11 = Bounty.create!(title: "How many arguments", content: "can't get my function that takes a random number of arguments to work", price_cents: Money.new(10_500), difficulty_level: 2, github_repo: "https://github.com/quynpham/adoptme", user: user)
bounty12 = Bounty.create!(title: "the main controller of my meatball application isn't working", content: "my poorly designed cheap webapp isn't working", price_cents: Money.new(1_500), difficulty_level: 1, github_repo: "https://github.com/lewagon/rails-watch-list", user: user5)
bounty13 = Bounty.create!(title: "Currency conversion in JavaScript", content: "Convert between different currencies using JavaScript", price_cents: Money.new(11_500), difficulty_level: 4, github_repo: "https://github.com/lewagon/food-delivery", user: user1)
bounty14 = Bounty.create!(title: "Add React Components", content: "Add React components to the application", price_cents: Money.new(12_800), difficulty_level: 4, github_repo: "https://github.com/user/react-components", user: user1)
bounty15 = Bounty.create!(title: "Fixing the Database that i can't query properly", content: 'Incorrectly querying the database', price_cents: Money.new(1_900), difficulty_level: 2, github_repo: 'https://github.com/lewagon/dribbble-card-solution', user: user)
